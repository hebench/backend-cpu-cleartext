...
#ifndef _HEBench_Bench_EltMult_SRC_7e5fa8c2415240ea93eff148ed73539b
#define _HEBench_Bench_EltMult_SRC_7e5fa8c2415240ea93eff148ed73539b
...
#include "../bench_eltmult.h"
#include "benchmarks/Vector/include/vec_data_container.h"
#include "clear_engine.h"
#include "clear_error.h"

//-------------------------------------------
// class EltMult_Benchmark
//-------------------------------------------

template <class T>
inline EltMult_Benchmark<T>::EltMult_Benchmark(hebench::cpp::BaseEngine &engine,
                                               const hebench::APIBridge::BenchmarkDescriptor &bench_desc,
                                               const hebench::APIBridge::WorkloadParams &bench_params) :
    ClearTextBenchmark(engine, bench_desc)
{
    hebench::cpp::WorkloadParams::EltwiseMultiply w_params(bench_params);
...
template <class T>
inline EltMult_Benchmark<T>::~EltMult_Benchmark()
{
}
...
template <class T>
inline hebench::APIBridge::Handle EltMult_Benchmark<T>::load(const hebench::APIBridge::Handle *p_local_data,
                                                             std::uint64_t count)
{
...
template <class T>
inline void EltMult_Benchmark<T>::store(hebench::APIBridge::Handle remote_data,
...
template <class T>
inline hebench::APIBridge::Handle EltMult_Benchmark<T>::operate(hebench::APIBridge::Handle h_remote_packed,
                                                                const hebench::APIBridge::ParameterIndexer *p_param_indexers)
{
         ...
         ++param_i[0])
    {
             ...
             ++param_i[1])
        {
            ...
            eltMult(result_data, data[0], data[1], m_vector_size);
            ++next_result;
        } // end for
    } // end for
...
template <class T>
void EltMult_Benchmark<T>::eltMult(gsl::span<T> &result,
...
#endif // defined _HEBench_Bench_EltMult_SRC_7e5fa8c2415240ea93eff148ed73539b
