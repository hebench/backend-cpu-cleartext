...
#ifndef _HEBench_ClearText_DotProd_L_H_7e5fa8c2415240ea93eff148ed73539b
#define _HEBench_ClearText_DotProd_L_H_7e5fa8c2415240ea93eff148ed73539b
...
template <class T>
class DotProd_L_Description : public hebench::cpp::BenchmarkDescription
{
public:
    DotProd_L_Description();
    ~DotProd_L_Description() override {}
...
private:
    void init();
    HEBERROR_DECLARE_CLASS_NAME(DotProd_L_Description)
};

template <>
inline DotProd_L_Description<std::int32_t>::DotProd_L_Description()
{
    init();
...
template <>
inline DotProd_L_Description<std::int64_t>::DotProd_L_Description()
{
    init();
...
template <>
inline DotProd_L_Description<float>::DotProd_L_Description()
{
    init();
...
template <>
inline DotProd_L_Description<double>::DotProd_L_Description()
{
    init();
...
template <class T>
inline void DotProd_L_Description<T>::init()
{
...
template <class T>
inline hebench::cpp::BaseBenchmark *DotProd_L_Description<T>::createBenchmark(hebench::cpp::BaseEngine &engine, const hebench::APIBridge::WorkloadParams *p_params)
{
    return engine.template createObj<DotProd_Benchmark<T>>(engine, m_descriptor, *p_params);
}

template <class T>
inline void DotProd_L_Description<T>::destroyBenchmark(hebench::cpp::BaseBenchmark *p_bench)
{
    if (p_bench)
    {
...
#endif // defined _HEBench_ClearText_DotProd_L_H_7e5fa8c2415240ea93eff148ed73539b
